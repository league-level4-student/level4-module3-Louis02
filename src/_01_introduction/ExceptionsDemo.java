...
//		}
		...
		try {
			testMethod2(6);
		} catch (CustomExxception e) {
			// TODO Auto-generated catch block
			CustomExxception ct = new CustomExxception();
	...
	public static void testMethod2(int x) throws CustomExxception{
		if(x<0) {
			throw new CustomExxception();
		}
	}
